...
import net.avicus.atlas.core.module.objectives.StagnatedCompletionObjective;
import net.avicus.atlas.core.module.objectives.TouchableObjective;
import net.avicus.atlas.core.module.objectives.locatable.LocatableObjective;
