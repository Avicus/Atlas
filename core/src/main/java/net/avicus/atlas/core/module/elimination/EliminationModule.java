package net.avicus.atlas.core.module.elimination;
...
import net.avicus.atlas.core.event.group.PlayerChangeGroupEvent;
...
import net.avicus.atlas.core.module.elimination.event.TeamEliminateEvent;
