...
import net.avicus.atlas.core.documentation.FeatureDocumentation.FeatureDocumentationBuilder;
import net.avicus.atlas.core.documentation.ModuleDocumentation;
import net.avicus.atlas.core.documentation.ModuleDocumentation.ModuleCategory;
import net.avicus.atlas.core.documentation.ModuleDocumentation.ModuleDocumentationBuilder;
