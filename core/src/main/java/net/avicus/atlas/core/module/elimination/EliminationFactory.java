...
import net.avicus.atlas.core.module.elimination.executor.ModifyLivesExecutor;
import net.avicus.atlas.core.module.elimination.executor.ToggleEliminationExecutor;
