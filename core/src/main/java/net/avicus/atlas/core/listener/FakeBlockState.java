 ...
 *
 * This is purely to represent what a block is going to be after an event finishes firing and should
 * not be used unless absolutely necessary. As such, any update or metadata methods will throw an
