package net.avicus.atlas.core.module.checks;
...
import net.avicus.atlas.core.match.registry.StaticReference;
...
import net.avicus.atlas.core.module.checks.modifiers.AllowCheck;
import net.avicus.atlas.core.module.checks.modifiers.AnyCheck;
import net.avicus.atlas.core.module.checks.modifiers.DenyCheck;
import net.avicus.atlas.core.module.checks.modifiers.NotCheck;
import net.avicus.atlas.core.module.checks.types.AttackerCheck;
import net.avicus.atlas.core.module.checks.types.CarryingCheck;
import net.avicus.atlas.core.module.checks.types.DamageCheck;
import net.avicus.atlas.core.module.checks.types.EntityTypeCheck;
import net.avicus.atlas.core.module.checks.types.FlyingCheck;
import net.avicus.atlas.core.module.checks.types.HoldingCheck;
import net.avicus.atlas.core.module.checks.types.InsideCheck;
import net.avicus.atlas.core.module.checks.types.ItemCheck;
import net.avicus.atlas.core.module.checks.types.KillStreakCheck;
import net.avicus.atlas.core.module.checks.types.KitCheck;
import net.avicus.atlas.core.module.checks.types.LambdaCheck;
import net.avicus.atlas.core.module.checks.types.MaterialCheck;
import net.avicus.atlas.core.module.checks.types.ObjectiveCheck;
import net.avicus.atlas.core.module.checks.types.ObjectiveCheck.CheckType;
import net.avicus.atlas.core.module.checks.types.OnGroundCheck;
import net.avicus.atlas.core.module.checks.types.RandomCheck;
import net.avicus.atlas.core.module.checks.types.ScoreCheck;
import net.avicus.atlas.core.module.checks.types.SneakingCheck;
import net.avicus.atlas.core.module.checks.types.SometimesCheck;
import net.avicus.atlas.core.module.checks.types.SpawnCheck;
import net.avicus.atlas.core.module.checks.types.SprintingCheck;
import net.avicus.atlas.core.module.checks.types.StateCheck;
import net.avicus.atlas.core.module.checks.types.TeamCheck;
import net.avicus.atlas.core.module.checks.types.TimeCheck;
import net.avicus.atlas.core.module.checks.types.VictimCheck;
import net.avicus.atlas.core.module.checks.types.VoidCheck;
import net.avicus.atlas.core.module.checks.types.WearingCheck;
import net.avicus.atlas.core.module.checks.types.WeatherCheck;
...
import net.avicus.atlas.core.module.kits.Kit;
...
import net.avicus.atlas.core.util.xml.XmlAttribute;
...
public class ChecksFactory implements ModuleFactory<Module> {
  ...
  static {
    ...
    FEATURES.add(FeatureDocumentation.builder()
        ...
        .attribute("state",
            new EnumAttribute(CheckType.class, false, "The score to check for."))
        .attribute("id", Attributes.id(false))
