...
import net.avicus.atlas.core.map.author.Minecrafter;
...
import net.avicus.atlas.core.module.loadouts.type.HealthLoadout;
...
import net.avicus.atlas.core.module.loadouts.type.MovementLoadout;
import net.avicus.atlas.core.module.loadouts.type.PopulatorLoadout;
import net.avicus.atlas.core.module.loadouts.type.VehicleLoadout;
import net.avicus.atlas.core.module.loadouts.type.VisualLoadout;
import net.avicus.atlas.core.module.loadouts.type.XPLoadout;
...
import net.avicus.atlas.core.util.color.TeamColorProvider;
import net.avicus.atlas.core.util.inventory.RandomizableItemStack;
import net.avicus.atlas.core.util.inventory.populator.InventoryPopulator;
import net.avicus.atlas.core.util.inventory.populator.RandomInventoryPopulator;
import net.avicus.atlas.core.util.xml.GenericXmlString;
