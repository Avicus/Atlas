...
import net.avicus.atlas.core.channel.Channel;
...
public class StaffChannels implements CommandComponent, ListenerComponent {
  ...
  public void enable() {
    ...
    final ChannelManager cm = Atlas.get().getChannelManager();
  ...
  public void playerJoin(final PlayerJoinEvent event) {
    ...
    if (!PlayerSettings.get(player, SETTING)) {
      player.sendMessage(Translations.SETTING_STAFFCHANNELS_DISABLED.with());
    }
  }
}
