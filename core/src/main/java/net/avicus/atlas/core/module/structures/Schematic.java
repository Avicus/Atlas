package net.avicus.atlas.core.module.structures;
 ...
 * <p>
 * All arrays are based on an index of: y coord * width * length + z coord * width + x coord, where
 * the coordinates are relative based on the minimum corner of the schematic region.
 */
@Getter
@ToString
