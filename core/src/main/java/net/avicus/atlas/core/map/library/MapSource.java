package net.avicus.atlas.core.map.library;
...
public interface MapSource {
  ...
  /**
   * Copy files from a subdirectory in this source to a folder. This will also copy a {@code
   * map.xml} from the source's root.
   *
   * @param path path to copy the files to
