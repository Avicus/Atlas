...
import net.avicus.atlas.core.module.zones.zones.ExecutionZone;
import net.avicus.atlas.core.module.zones.zones.LoadoutApplicationZone;
import net.avicus.atlas.core.module.zones.zones.TNTCustomizationZone;
import net.avicus.atlas.core.module.zones.zones.TransportZone;
import net.avicus.atlas.core.module.zones.zones.VelocityModZone;
import net.avicus.atlas.core.module.zones.zones.filtered.FilteredInteractionZone;
import net.avicus.atlas.core.module.zones.zones.filtered.FilteredLiquidZone;
import net.avicus.atlas.core.module.zones.zones.filtered.FilteredLiquidZone.LiquidRule;
import net.avicus.atlas.core.module.zones.zones.filtered.FilteredMovementZone;
...
public class ZonesFactory implements ModuleFactory<ZonesModule> {
        ...
        .subFeature(FeatureDocumentation.builder()
            ...
            .subFeature(FeatureDocumentation.builder()
                ...
                .attribute("water-rule",
                    new EnumAttribute(LiquidRule.class, true,
            ...
            .subFeature(FeatureDocumentation.builder()
                ...
                .attribute("lava-rule", new EnumAttribute(LiquidRule.class, true,
                    "The liquid rule that should be used."))
                .build())
            .build())
        .subFeature(FeatureDocumentation.builder()
  ...
  private Zone parseZone(Match match, XmlElement element) {
    ...
    Optional<LiquidRule> waterRule = element.getAttribute("water-rule")
        .asEnum(LiquidRule.class, true);
    Optional<LiquidRule> lavaRule = element.getAttribute("lava-rule")
        .asEnum(LiquidRule.class, true);
