package net.avicus.atlas.core.match;
...
import net.avicus.atlas.core.map.library.MapSource;
...
import net.avicus.atlas.core.module.broadcasts.BroadcastsFactory;
import net.avicus.atlas.core.module.channels.ChannelsFactory;
import net.avicus.atlas.core.module.checks.CheckContext;
import net.avicus.atlas.core.module.checks.ChecksFactory;
import net.avicus.atlas.core.module.chests.ChestsFactory;
import net.avicus.atlas.core.module.compass.CompassFactory;
import net.avicus.atlas.core.module.damage.DamageFactory;
import net.avicus.atlas.core.module.decay.DecayFactory;
import net.avicus.atlas.core.module.display.DisplayFactory;
import net.avicus.atlas.core.module.doublekill.DoubleKillFactory;
import net.avicus.atlas.core.module.elimination.EliminationFactory;
import net.avicus.atlas.core.module.enderchests.EnderChestsFactory;
import net.avicus.atlas.core.module.executors.ExecutorsFactory;
import net.avicus.atlas.core.module.fakeguis.FakeGUIsFactory;
import net.avicus.atlas.core.module.groups.GroupsFactory;
import net.avicus.atlas.core.module.invsee.InvSeeFactory;
import net.avicus.atlas.core.module.items.ItemsFactory;
import net.avicus.atlas.core.module.kills.KillsFactory;
import net.avicus.atlas.core.module.kits.KitsFactory;
import net.avicus.atlas.core.module.loadouts.LoadoutsFactory;
import net.avicus.atlas.core.module.locales.LocalesFactory;
import net.avicus.atlas.core.module.modifydamage.ModifyDamageFactory;
import net.avicus.atlas.core.module.objectives.ObjectivesFactory;
import net.avicus.atlas.core.module.projectiles.ProjectilesFactory;
import net.avicus.atlas.core.module.regions.RegionsFactory;
import net.avicus.atlas.core.module.resourcepacks.ResourcePacksFactory;
import net.avicus.atlas.core.module.results.ResultsFactory;
import net.avicus.atlas.core.module.shop.ShopsFactory;
import net.avicus.atlas.core.module.spawns.SpawnsFactory;
import net.avicus.atlas.core.module.states.StatesFactory;
import net.avicus.atlas.core.module.stats.StatsFactory;
import net.avicus.atlas.core.module.structures.StructuresFactory;
import net.avicus.atlas.core.module.vote.VoteModuleFactory;
import net.avicus.atlas.core.module.world.WorldFactory;
import net.avicus.atlas.core.module.zones.ZonesFactory;
import net.avicus.atlas.core.util.xml.XmlElement;
import net.avicus.atlas.core.util.xml.conditionals.ConditionalContext;
import net.avicus.atlas.core.util.xml.conditionals.ConditionalsFactory;
import net.avicus.atlas.core.util.xml.groups.ModuleGroup;
import net.avicus.atlas.core.util.xml.groups.ModuleGroupsFactory;
...
/**
 * A match factory controls the construction of {@link Match}s from a collection of registered
 * {@link ModuleFactory module factories}.
 */
