...
import net.avicus.atlas.core.event.competitor.CompetitorPlaceEvent;
import net.avicus.atlas.core.event.competitor.CompetitorWinEvent;
...
import net.avicus.atlas.core.module.results.RankingDisplay;
