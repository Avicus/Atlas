...
import static net.avicus.atlas.core.util.ObjectiveUtils.ARROW_ALTERNATOR;
import static net.avicus.atlas.core.util.ObjectiveUtils.CHECK_MARK;
import static net.avicus.atlas.core.util.ObjectiveUtils.FLAG_EMPTY;
import static net.avicus.atlas.core.util.ObjectiveUtils.FLAG_FILLED;
import static net.avicus.atlas.core.util.ObjectiveUtils.SEPARATOR;
import static net.avicus.atlas.core.util.ObjectiveUtils.SQUARE_EMPTY;
import static net.avicus.atlas.core.util.ObjectiveUtils.SQUARE_FILLED;
import static net.avicus.atlas.core.util.ObjectiveUtils.SQUARE_SHADED;
import static net.avicus.atlas.core.util.ObjectiveUtils.TOUCH;
